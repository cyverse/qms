...
--
UPDATE plan_quota_defaults SET quota_value = 5 * 2^30 WHERE id = '60b3d5ae-9511-11ec-8844-406c8f3e9cbb';
UPDATE plan_quota_defaults SET quota_value = 50 * 2^30 WHERE id = '0ebd2c19-7c1d-4418-a02f-df5f6d782901';
UPDATE plan_quota_defaults SET quota_value = 3 * 2^40 WHERE id = '2c39ff2f-2ec7-4ac8-a10e-79fd82b39c09';
UPDATE plan_quota_defaults SET quota_value = 5 * 2^40 WHERE id = 'de496045-b954-4f41-b068-3c71b32d2287';
